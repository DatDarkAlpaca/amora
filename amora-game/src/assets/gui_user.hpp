...
namespace amo
{
	...
	public:
		...
		{
            render_borders(console);

            render_player_status(console);
		}

    private:
        void render_borders(NON_OWNING AmoraConsole* console)
        {
            CHAR_INFO wall;
            wall.Char.AsciiChar = ' ';
        ...
        void render_player_status(NON_OWNING AmoraConsole* console)
        {
